...
(function (root, factory) {
  ...
  function (root, undefined) {
    ...
    var registerCommand = function registerCommand(
      command,
      callback,
      originalPhrase
    ) {
    ...
    annyang = {
        ...
        for (var phrase in commands) {
          if (commands.hasOwnProperty(phrase)) {
            ...
            if (typeof cb === "function") {
              ...
              (typeof cb === "undefined" ? "undefined" : _typeof(cb)) ===
                "object" &&
      ...
      removeCallback: function removeCallback(type, callback) {
        var compareWithCallbackParameter =
          function compareWithCallbackParameter(cb) {
