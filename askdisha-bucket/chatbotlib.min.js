...
script2.src =
  "https://cdn.jsdelivr.net/gh/corover/assets@t86/askdisha-bucket/chatbot_IRCTC_V2.js?" +
  new Date().getTime();

  var script3 = document.createElement("script");

script3.src =
    "https://cdn.jsdelivr.net/gh/corover/assets@t86/askdisha-bucket/chatbot_IRCTC_AD.js?" +
    new Date().getTime();
