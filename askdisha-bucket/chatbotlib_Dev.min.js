...
//redirect
script2.src =
  "https://cdn.jsdelivr.net/gh/corover/assets@3jan-t17/askdisha-bucket/chatbot_IRCTC_Dev.js?" +
  new Date().getTime();

  var script3 = document.createElement("script");

script3.src =
    "https://cdn.jsdelivr.net/gh/corover/assets@3jan-t17/askdisha-bucket/chatbot_IRCTC_Ad_Dev.js?" +
    new Date().getTime();
