            ...
            margin-bottom: -2px;">SALE
                 ...
                 ">
                  ...
                  <a href="https://amzn.to/4h0EeGZ" target="_blank" style="display: block;">
                    <div id="scrollIframeContainer" style="height: ${mediaObj.belowAD.height}; width: ${mediaObj.belowAD.width}; margin-left: ${mediaObj.belowAD.margin}; margin-top: -20px; transform: scale(${mediaObj.belowAD.scale}); background:url('https://cdn.jsdelivr.net/gh/corover/assets@27feb_ir1/askdisha-bgucket/1.sv'); background-repeat: no-repeat; background-size: contain !important;">
                    </div>
                  </a>
              </div>
                  </div>
