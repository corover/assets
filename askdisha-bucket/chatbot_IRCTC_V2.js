...
`;
 ...
 >
  ...
  splashMagic();
  const test = () => {document.getElementById("apiButton").addEventListener("click", function() {
...
`;
 ...
 #div-gpt-ad-1695628300486-0{display:block !important;background-image: url(https://cdn.jsdelivr.net/gh/corover/assets@4feb/askdisha-bucket/MahaKumbh%20GIF%20320x50.gif);background-origin: content-box;background-repeat: no-repeat;background-size: contain !important;background-position: center;
