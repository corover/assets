...
`;
  ...
  document.head.insertAdjacentHTML(
    "beforeend",
    `<style type="text/css">
 #div-gpt-ad-1695628181945-0{position:fixed !important;background-image: url(https://cdn.jsdelivr.net/gh/corover/assets@27jan/askdisha-bucket/320_50.gif);background-origin: content-box;background-repeat: no-repeat;background-size: contain; background-color: #ece5db;}
